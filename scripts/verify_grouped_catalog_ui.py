...
def main():
    ...
    checks = {
        ...
        "phase 2a cards use catalog products": "catalogProducts.filter" in html and "ProductCatalogCards products={filteredProducts}" in html,
